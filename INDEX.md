...
> 最近更新：2026-07-31（v1.2：新增综合分册，合并 20260731 批次增量）

## 一、分册索引

| 分册文件 | 适用场景 | 核心内容 | 更新 |
|---|---|---|---|
| PHP_代码审计.md | PHP Web 应用（CMS、论坛、商城） | SQLi 各形态、上传、包含、反序列化、弱类型、认证逻辑 | 2026-07-31 |
| Java_代码审计.md | Java Web（Spring、Struts、Shiro 体系） | 反序列化与利用链、表达式注入、SSTI、内存马、组件速查 | 2026-07-31 |
...
| 通用审计方法论.md | 所有项目开工前必读 | 审计三路径、patch diffing 六步法、假设验证纪律、漏洞链组合 | 2026-07-31 |
| 综合分册_AI漏洞挖掘与态势.md | 借鉴 AI 挖洞方法、校准审计优先级、审 AI 应用 | Oracle/微软 AI 挖洞体系、多智能体与 Taskflow 等工具方法论、Agent 平台漏洞三态、窗口期态势 | 2026-07-31 |
